...
$student_session=$_SESSION['student_login'];


$query="SELECT * FROM `students` WHERE `email`='$student_session'";
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?= ucwords($result['fname'].' '.$result['lname']);?></span>
                    ...
                    <div class="user-options dropdown-box">
                        <div class="drop-content basic">
                            <ul>
                                <li> <a href="student-profile.php?id=<?= $result['id'];?>"><i class="fa fa-user" aria-hidden="true"></i>Profile</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
